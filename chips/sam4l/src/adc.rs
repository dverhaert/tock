...
impl Adc {
    ...
    fn config_and_enable(&self, frequency: u32) -> ReturnCode {
        if self.active.get() {
            ...
            let tim_val =
                TimingConfiguration::ENSTUP::Enable + TimingConfiguration::STARTUP.val(0x17); // wait 24 cycles
            regs.tim.write(tim_val);
            ...
            let cr_val = Control::BGREQEN::SET + Control::REFBUFEN::SET;
            regs.cr.write(cr_val);
